...
The plot.py is optionnal, it creates a Graph folder, takes the csv file and use it to plot the frequency of each pair by distance in 10 different images.
